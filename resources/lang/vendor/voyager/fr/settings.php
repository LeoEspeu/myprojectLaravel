...
return [
    ...
    'update_answer'        => 'Êtes-vous sûr de vouloir mettre à jour le paramètre : :setting ?',
    'update_confirm'       =>'Oui, mettre à jour ce paramètre',
    'title' => [
        'browser_cache'    => 'Gestion des caches'
    ],
];
